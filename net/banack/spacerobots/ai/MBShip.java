...
public class MBShip extends AIShip
{
	...
	protected MBFleet myFleet;
	
	private static class MBShipIterator implements Iterator<MBShip>
	{
		private Iterator<AIShip> i;
		
		public MBShipIterator(Iterator<AIShip> it)
		{
			i = it;
		}
	...
	public static Iterator<MBShip> wrapIterator(Iterator<AIShip> i)
	{
		return new MBShipIterator(i);
	}
	
	
	public MBShip(Ship s)
	{
		super(s);
		myFleet = null;
	}
	
	public MBShip(Ship s, MBFleet f)
	{
		super(s);
		myFleet = f;
	}
