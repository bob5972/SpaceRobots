...
public class TestSpaceMath
{
	...
	/**
	 * Test method for
	 * {@link net.banack.spacerobots.util.SpaceMath#rotate(net.banack.geometry.DPoint, net.banack.geometry.DPoint, double)}
	 * .
	 */
	@Test
	...
	/**
	 * Test method for
	 * {@link net.banack.spacerobots.util.SpaceMath#findCenter(net.banack.geometry.DPoint, net.banack.geometry.DPoint, net.banack.geometry.DPoint, net.banack.geometry.DPoint)}
	 * .
	 */
	@Test
	...
	/**
	 * Test method for
	 * {@link net.banack.spacerobots.util.SpaceMath#rotate(net.banack.geometry.DQuad, net.banack.geometry.DPoint, double)}
	 * .
	 */
	@Test
	...
	/**
	 * Test method for
	 * {@link net.banack.spacerobots.util.SpaceMath#getDQuad(net.banack.geometry.DPoint, double, double, double)}.
	 */
	@Test
	...
	/**
	 * Test method for
	 * {@link net.banack.spacerobots.util.SpaceMath#isIntersection(net.banack.geometry.DPoint, net.banack.geometry.DPoint, net.banack.geometry.DPoint, net.banack.geometry.DPoint)}
	 * .
	 */
	@Test
	...
	/**
	 * Test method for
	 * {@link net.banack.spacerobots.util.SpaceMath#containsPoint(net.banack.geometry.DPoint, net.banack.geometry.DQuad)}
	 * .
	 */
	@Test
	...
	/**
	 * Test method for
	 * {@link net.banack.spacerobots.util.SpaceMath#isCollision(net.banack.geometry.DQuad, net.banack.geometry.DQuad)}.
	 */
	@Test
	...
	/**
	 * Test method for
	 * {@link net.banack.spacerobots.util.SpaceMath#containsPoint(net.banack.geometry.DPoint, net.banack.geometry.DArc)}
	 * .
	 */
	@Test
	...
	/**
	 * Test method for
	 * {@link net.banack.spacerobots.util.SpaceMath#isCollision(net.banack.geometry.DArc, net.banack.geometry.DQuad)}.
	 */
	@Test
	public void testIsCollisionDArcDQuad()
	{
		...
		r = new DQuad(new DPoint(98, 50 + 16), new DPoint(99, 50 + 16), new DPoint(99, 50 + 15),
		        new DPoint(98, 50 + 15));
		Assert.assertFalse(SpaceMath.isCollision(arc, r));
		...
		r = new DQuad(new DPoint(50.18700890282735, 133.76241449674657), new DPoint(-128.12627167394078,
		        -94.49152127906225), new DPoint(65.93818143705835, 124.993117843258), new DPoint(50.986155842519054,
		        123.7943974337204));
		Assert.assertFalse(SpaceMath.isCollision(arc, r));
		
		arc = new DArc(new DPoint(283.3, 58.0), 40, -0.35, 0.7);
		r = new DQuad(new DPoint(284.1980199960244, 203.29457416972397), new DPoint(294.8617230662086,
		        -86.15623454226986), new DPoint(301.89451725821266, 206.73463007760736), new DPoint(291.2308141880285,
		        196.1854387896012));
		Assert.assertFalse(SpaceMath.isCollision(arc, r));
		
		arc = new DArc(new DPoint(0, 0), 40, 0, 0.7);
		r = new DQuad(new DPoint(46.523960398395516, -141.61749566123808), new DPoint(51.522081884704996,
		        -141.75454166844565), new DPoint(51.385035877497444, -146.7526631547551), new DPoint(
		        46.386914391187965, -146.61561714754754));
		Assert.assertFalse(SpaceMath.isCollision(arc, r));
	}
}
